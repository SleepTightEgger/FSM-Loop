...
namespace NodeCanvas.Tasks.Actions {
	...
	public class RepairAT : ActionTask
	{
		...
		public float repairRate = 25f; /* in seconds */
        ...
        protected override void OnExecute()
        {
			...
			repairValue = lightTowerBB.GetVariableValue<float>("repairValue"); // retrieve data from another blackboard
		...
		protected override void OnUpdate()
		{
			...
			lightTowerBB.SetVariableValue("repairValue", repairValue); // set data in another blackboard
